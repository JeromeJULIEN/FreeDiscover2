...
extension UserProfile {
    static let marion = UserProfile(id: 1,userName: "Marion", userPicture: "marion",userContributions: [1,2,5],userFavorites: [1,2],userUpVote: [4,5,13,12],userDownVote: [2])
    ...
    static let ben =  UserProfile(id:4,userName: "Ben", userPicture: "ben", userContributions: [],userFavorites: [1,5],userUpVote: [1,5],userDownVote: [2])
